...
K_s = 15000
K_e = 19*10
K, L, X = loadFusionStructure("drone_v4",strut_L = 0.55, strut_K=K_s, elastic_K=K_e, override_L=True)
K, L, X = find_stability(K, L, X, Debugger, display_time=0, step=0.00001, iter = 100000)
print("done")
save_fusion360(X, K)
